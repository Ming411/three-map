...
!(function (n, t) {
  ...
  function Un(n, t) {
    ...
    var r = E((t *= h)),
      ...
      o = x(t),
      u = d(
        N((u = Rn * o - Cn * e) * u + (u = Cn * i - wn * o) * u + (u = wn * e - Rn * i) * u),
        wn * i + Rn * e + Cn * o
      );
    (hn += u),
      (En += u * (wn + (wn = i))),
  ...
  function ot(n, t, r, i, e, o) {
    if (r) {
      ...
      null == e
        ? ((e = t + i * s), (o = t - a / 2))
        : ((e = ut(u, e)), (o = ut(u, o)), (i > 0 ? e < o : e > o) && (e += i * s));
  ...
  function gt(n, t) {
    ...
    for (var h = 0, g = n.length; h < g; ++h)
      if ((y = (v = n[h]).length))
        for (
          var v, y, S = v[y - 1], m = ht(S), M = S[1] / 2 + f, _ = x(M), N = E(M), w = 0;
          w < y;
          ++w, m = P, _ = j, N = q, S = R
        ) {
          var R = v[w],
        ...
        if ((a.pop(), u.push(a), (a = null), h))
          if (1 & e) {
            if ((t = (r = l[0]).length - 1) > 0) {
              for (p || (o.polygonStart(), (p = !0)), o.lineStart(), n = 0; n < t; ++n)
                o.point((i = r[n])[0], i[1]);
              o.lineEnd();
            }
  ...
  function Et(n, t) {
    return (
      ((n = n.x)[0] < 0 ? n[1] - l - u : l - n[1]) - ((t = t.x)[0] < 0 ? t[1] - l - u : l - t[1])
    );
  }
  var yt = vt(
    function () {
            ...
            : e !== f &&
              ...
              (i = (function (n, t, r, i) {
                var e,
                  ...
                  c = x(n - r);
                return g(c) > u
                  ? v((x(t) * (o = E(i)) * x(r) - x(i) * (e = E(t)) * x(n)) / (e * o * c))
                  : (t + i) / 2;
              })(r, i, o, c)),
              n.point(e, i),
              n.lineEnd(),
  ...
  function xt(n, r, i, e) {
    ...
    return function (u) {
          ...
          polygonEnd: function () {
            var r = (function () {
                for (var t = 0, r = 0, i = f.length; r < i; ++r)
                  for (
                    var o, u, c = f[r], a = 1, l = c.length, s = c[0], p = s[0], h = s[1];
                    a < l;
                    ++a
                  )
                    (o = p),
      ...
      function N(t, u) {
        var c = o(t, u);
        if ((f && s.push([t, u]), y))
          (p = t), (h = u), (g = c), (y = !1), c && (m.lineStart(), m.point(t, u));
    ...
    return (
      ...
      (M.outline = function () {
        return {
          type: 'Polygon',
          coordinates: [
            p(e).concat(h(a).slice(1), p(i).reverse().slice(1), h(l).reverse().slice(1))
          ]
        };
      }),
      (M.extent = function (n) {
    ...
    point: function (n, t) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        default:
          null == this._circle && (this._circle = Br(this._radius)),
          ...
          function r(i, e, o, c, a, l, f, s, p, h, v, E, y, S) {
            ...
            if (x > 4 * t && y--) {
              ...
              ((G * G) / x > t ||
                g((m * L + M * O) / x - 0.5) > 0.3 ||
                c * h + a * v + l * E < Vr) &&
                (r(i, e, o, c, a, l, z, b, j, (_ /= P), (w /= P), R, y, S),
                S.point(z, b),
      ...
      (P.clipExtent = function (n) {
        return arguments.length
          ? ((R =
              null == n
                ? ((w = i = e = o = null), Xt)
                : xt((w = +n[0][0]), (i = +n[0][1]), (e = +n[1][0]), (o = +n[1][1]))),
            q())
          : null == w
          ? null
          : [
  ...
  function _i(n, t) {
    var r = C(xi * x(t)),
      ...
      e = i * i * i;
    return [
      (n * E(r)) / (xi * (yi + 3 * Si * i + e * (7 * mi + 9 * Mi * i))),
      r * (yi + Si * i + e * (mi + Mi * i))
    ];
  }
  function Ni(n, t) {
  ...
  (_i.invert = function (n, t) {
    for (
      ...
      ((o =
        (e =
          (i -= r =
            (i * (yi + Si * e + o * (mi + Mi * e)) - t) /
            (yi + 3 * Si * e + o * (7 * mi + 9 * Mi * e))) * i) *
        e *
        e),
      !(g(r) < c));
      ++u
    ...
    (Ri.invert = function (n, t) {
      ...
      return [
        n /
          (0.8707 +
            (o = i * i) * (o * (o * o * o * (0.003971 - 0.001529 * o) - 0.013791) - 0.131979)),
        i
      ];
    }),
    (Ci.invert = li(C)),
    ...
    (n.geoAlbersUsa = function () {
      ...
      return (
        ...
        (s.scale = function (n) {
          return arguments.length
            ? (c.scale(n), a.scale(0.35 * n), l.scale(n), s.translate(c.translate()))
            : c.scale();
        }),
        ...
        clipExtent: function (i) {
          return arguments.length
            ? ((h =
                null == i
                  ? ((p = n = t = r = null), Xt)
                  : xt((p = +i[0][0]), (n = +i[0][1]), (t = +i[1][0]), (r = +i[1][1]))),
              g())
            : null == p
            ? null
            : [
    ...
    (n.geoPath = function (n, t) {
      ...
      function o(n) {
        return (
          n && ('function' == typeof e && i.pointRadius(+e.apply(this, arguments)), O(n, r(i))),
          i.result()
        );
      }
      return (
        ...
        (o.context = function (n) {
          return arguments.length
            ? ((i = null == n ? ((t = null), new Wr()) : new zr((t = n))),
        ...
        (o.pointRadius = function (n) {
          return arguments.length
            ? ((e = 'function' == typeof n ? n : (i.pointRadius(+n), +n)), o)
            : e;
        }),
